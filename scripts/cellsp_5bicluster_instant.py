...
print(f"====== Biclustering InSTAnT for sample {sample} and cell type {cellType}... ======")
...
print(f"Running InSTAnT biclustering for sample {sample} and cell type {cellType}...") 

## Perform biclustering of InSTAnT output gene-gene collocalization matrix
adata_st = cellSP.ch.bicluster_instant(adata_st, distance_threshold=instant_dist, threads=nthreads, alpha=0.05, num_biclusters = 10, randomized_searches=5000, topk=500)
...
print(f"Writing anndata with InSTAnT biclustering results for sample {sample} and cell type {cellType}")
